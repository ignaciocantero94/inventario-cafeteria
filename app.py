...
#Aquí estamos usando para esta funcion el metodo POST, es lo que necesitamos poner para decirle al programa
# que queremos crear o añadir algún elemento.
...
#En esta funcion no añadimos GET, que sería lo que necesitamos para obtener el supplier, porque al definir "@app.route()"
# se declara por defecto GET.
...
#Aquí estamos creando una funcion para eliminar los datos de la tabla, simplemente hay que poner el if para confirmar
...
# Después de cada PUT, tenemos que ir a la terminal y añadir la funcionalidad de modificacion a nuestro server con el
# comando "curl".
...
# entran ('in') menos la cantidad de artículos que salen ('out'). Los valores que acepta movement.movement_type son: 'in/out'.
...
# Esto de aquí nos sirve para que el servidor siga en funcionamiento, es necesario en el momento que
# invocamos Flask.
